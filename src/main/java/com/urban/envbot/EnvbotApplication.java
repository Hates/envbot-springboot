...
@SpringBootApplication(scanBasePackages = {"me.ramswaroop.jbot", "com.urban.envbot"})
public class EnvbotApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(EnvbotApplication.class, args);
    }
}
